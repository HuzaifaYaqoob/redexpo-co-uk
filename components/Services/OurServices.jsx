...
const ServiceCard = () => {
    return (
        <div className={`max-w-[340px] w-full mx-auto bg-white rounded-md py-4 px-3 shadow-md mb-3 hover:border hover:border-red-600 cursor-pointer hover:-translate-y-4 hover:shadow-2xl transition-all`}>
            <img
...
const OurServicesSection = () => {
    return (
        <div className="mb-10 mt-20 px-5 md:px-0">
            ...
            <div className="w-full max-w-7xl mx-auto flex items-center flex-wrap gap-8 ">
                <ServiceCard />
                <ServiceCard />
                <ServiceCard />
                <ServiceCard />
