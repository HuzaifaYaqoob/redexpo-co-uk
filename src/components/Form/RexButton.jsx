...
class RexButton extends React.Component {
    constructor(props) {
        super(props)
        this.ref_svg = createRef()
    }
    componentDidMount() {
        console.log(this.ref_svg)
        this.startButton()
    }
    startButton() {
        ...
        this.width = options?.width * 1 || 100;
        ...
        this.color2 = options?.color2 || '#EA580C';
        this.color3 = options?.color3 || '#de2c23';
