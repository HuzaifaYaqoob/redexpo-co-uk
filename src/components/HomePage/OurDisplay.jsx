...
const OurDisplay = () => {
    return (
        <>
            <div className="max-w-[1100px] mx-auto text-white flex items-center justify-between mb-10">
                ...
                <div className="flex-1 min-h-[400px]">
                    ...
                    <div className="flex items-stretch mt-4 relative">
                        ...
                        <div className="absolute -bottom-10 z-0 left-1/3 w-44 h-44 rounded-full border-2 border-t-transparent border-gray-400 border-dashed"></div>
                    </div>
                </div>
            </div>
        </>
